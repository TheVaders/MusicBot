...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**Sangrammusicbot -** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**Sangrammusicbot -** ⏹ Stopped.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**Sangrammusicbot -** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**Sangrammusicbot -** ❇️ Admin cache refreshed!")
